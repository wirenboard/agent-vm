...
The Debian 13 base image is created automatically by exporting your existing Debian or Ubuntu WSL2 distro. If you don't have one yet, run `wsl --install Debian` first.
